...
--
-- Хост: 127.0.0.1
-- Время создания: Май 15 2023 г., 12:20
...
(32, '2023-05-09 10:07:56', 99, 6, 40);
...
INSERT INTO `computers` (`REG_Number`, `Name`, `Details`, `Computers_Category_REG_Number`, `Store_REG_Number`, `Status_REG_Number`) VALUES
(63, 'Стандартный компьютер 1', 'Стандартный компьютер', 2, NULL, 8),
(64, 'Стандартный компьютер 2', 'Стандартный компьютер', 2, NULL, 8),
(65, 'Стандартный компьютер 3', 'Стандартный компьютер', 2, NULL, 8),
(66, 'Стандартный компьютер 4', 'Стандартный компьютер', 2, NULL, 8);
...
(40, 'Крутое игровое место 2', 1442.00, 64, 5, 3),
(41, 'Крутое игровое место 3', 142.00, 65, 5, 3),
(43, 'Крутое игровое место 4', 142.00, 66, 5, 3),
(46, 'Крутое игровое место 5', 142.00, 65, 5, 3),
(47, 'Крутое игровое место 1', 2121.00, 63, 6, 3);
...
ALTER TABLE `computers`
  ...
  ADD KEY `Computers_Category_REG_Number` (`Computers_Category_REG_Number`,`Store_REG_Number`,`Status_REG_Number`),
...
--
ALTER TABLE `booking`
  MODIFY `REG_Number` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
